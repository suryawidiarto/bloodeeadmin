    ...
    <View style={styles.containerlist}>
      <View style={styles.item}>
        <Text style={styles.deskripsi}>
          Peminta Darah :{dataPermintaan.NamaPeminta}
        </Text>
        <Text style={styles.deskripsi}>
          Penerima Darah :{dataPermintaan.NamaPenerima}
        </Text>
        <Text style={styles.deskripsi}>
          Golongan Darah Dibutuhkan :{dataPermintaan.GolonganDarah}
        </Text>
        <Text style={styles.deskripsi}>
          Kantong Darah Dibutuhkan :{dataPermintaan.JumlahDarah}
        </Text>
        <Text style={styles.deskripsi}>
          Keterangan Lain : {dataPermintaan.KeteranganLain}
        </Text>
        <Text style={styles.deskripsi}>
          NoHandphone: {dataPermintaan.NoHandphone}
        </Text>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            Accept();
            navigation.replace('PermintaanDarahScreen');
          }}>
